...
<html>
    ...
    <p1>
        <button>fighter</button> <button>shooter</button> <button>rpg</button> <button> simulation </button>
        <button>sports</button> <button>augment reality</button> <button>virtual reality</button>
    ...
    <p2>
        <button>keyboard</button> <button>phone</button> <button>playstation / xbox controller</button> <button>switch
            controller</button> <button>fight stick</button> <button>voice <button>customize</button>
    </p2>
    <h2>
        Character Select
    </h2>
    <p2>
        <button>Stickman</button> <button>Ackma</button> <button>Duwen</button> <button>male
            non-human</button><button>Rukal</button>
        <button>Aunique</button>
        <button>Cece</button> <button>Reguli</button> <button>female human</button>
    </p2>
    ...
    <button id="wRTCconnectButton" name="wRTCconnectButton" class="wRTCbuttonleft">Connect</button>
    <button id="wRTCdisconnectButton" name="wRTCdisconnectButton" class="wRTCbuttonright" disabled>Disconnect</button>

    <div class="wRTCmessagebox">
        <label for="wRTCmessage">
            Enter a message:
            <input type="text" name="wRTCmessage" id="wRTCmessage" placeholder="Message text" inputmode="latin"
                size="60" maxlength="120" disabled />
        </label>
        <button id="wRTCsendButton" name="wRTCsendButton" class="wRTCbuttonright" disabled>Send</button>
    </div>

    <div class="wRTCmessagebox" id="wRTCreceive-box">
    ...
    <div class="flexChild" id="camera-container">
        <div class="camera-box">
            <video id="received_video" autoplay></video>
            <video id="local_video" autoplay muted></video>
            <button id="hangup-button" onclick="closeVideoCall();" disabled>Hang Up</button>
        </div>
    </div-->

        <!--svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
            y="0px" width="600px" height="500px" xml:space="preserve" viewBox="0 0 600 500">
            <g>
                <g>
    ...
    C103.685,224.744,108.96,229.15,114.003,232.84z" />
                    <path id="controller-b14" name="left" d="M92.962,233.11c-2.46-1.229-14.584-2.925-20.918-2.925c-0.502,0-0.937,0.012-1.31,0.042
    ...
    C268.527,201.874,269.353,202.859,270.437,203.63z" />
                    ...
                    <circle cx="290.000" cy="295.000" r="35" width="50.898" height="100.711" stroke="black" fill="black" />
                    ...
                    <rect id="controller-b6" x="99.994" y="50.0" height="50.898" width="35.5" fill="black" rx="19"
                        ry="10" />

                    <rect id="controller-b7" x="448.994" y="50.0" height="50.898" width="35.5" fill="black" rx="19"
                        ry="10" />

                    <circle id="controller-b10-below" name="left-stick" cx="200.000" cy="325.000"
                        data-original-x-position="200.000" data-original-y-position="325.000" r="15" width="50.898"
                        height="100.711" stroke="black" fill="black" />

                    <circle id="controller-b10" name="left-stick" cx="200.000" cy="325.000"
                        data-original-x-position="200.000" data-original-y-position="325.000" r="35" width="50.898"
                        height="100.711" fill="rgb(105, 4, 4)" />

                    <circle id="controller-b11-bottom" name="stick-right" cx="381.000" cy="325.000"
                        data-original-x-position="381.000" data-original-y-position="325.000" r="15" width="50.898"
                        height="100.711" stroke="black" fill="black" />

                    <circle id="controller-b11" name="stick-right" cx="381.000" cy="325.000"
                        data-original-x-position="381.000" data-original-y-position="325.000" r="35" width="50.898"
                        height="100.711" fill="rgb(105, 4, 4)" />
                </g>
            </g>
            <g></g>
...
<script type="module" src="./JS/sprite.js">
        ...
        window.addEventListener("message", async(ev) => {
            ...
            if (origin === "https://www.tsunamiflow.club" || "https://tsunamiflow.club") {
                ...
                if (data.type === "start_game") {
                    ...
                    return console.log(`Some outside source is trying to send my homepage a message. whihc is: ${ev.source}`);
                }
        });
    </script>
    </body>
