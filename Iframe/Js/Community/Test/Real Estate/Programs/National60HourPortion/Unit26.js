...
var hr60Unit26Questions = new Array(
...
RandomQuestion = Math.floor((Math.random() * Hr60Unit26Questions.length));
CurrentExam = Hr60Unit26Questions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr60Unit26Questions.length));
RandomWA2 = Math.floor((Math.random() * Hr60Unit26Questions.length));
RandomWA3 = Math.floor((Math.random() * Hr60Unit26Questions.length));
WrongAnswer1 = Hr60Unit26Questions[RandomWA1];
WrongAnswer2 = Hr60Unit26Questions[RandomWA2];
WrongAnswer3 = Hr60Unit26Questions[RandomWA3];
