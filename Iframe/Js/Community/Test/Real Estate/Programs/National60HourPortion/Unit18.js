...
var hr60Unit18Questions = new Array(
...
RandomQuestion = Math.floor((Math.random() * Hr60Unit18Questions.length));
CurrentExam = Hr60Unit18Questions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr60Unit18Questions.length));
RandomWA2 = Math.floor((Math.random() * Hr60Unit18Questions.length));
RandomWA3 = Math.floor((Math.random() * Hr60Unit18Questions.length));
WrongAnswer1 = Hr60Unit18Questions[RandomWA1];
WrongAnswer2 = Hr60Unit18Questions[RandomWA2];
WrongAnswer3 = Hr60Unit18Questions[RandomWA3];
