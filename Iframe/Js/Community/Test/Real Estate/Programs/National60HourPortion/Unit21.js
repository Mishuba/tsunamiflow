...
var hr60Unit21Questions = new Array(
...
RandomQuestion = Math.floor((Math.random() * Hr60Unit21Questions.length));
CurrentExam = Hr60Unit21Questions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr60Unit21Questions.length));
RandomWA2 = Math.floor((Math.random() * Hr60Unit21Questions.length));
RandomWA3 = Math.floor((Math.random() * Hr60Unit21Questions.length));
WrongAnswer1 = Hr60Unit21Questions[RandomWA1];
WrongAnswer2 = Hr60Unit21Questions[RandomWA2];
WrongAnswer3 = Hr60Unit21Questions[RandomWA3];
