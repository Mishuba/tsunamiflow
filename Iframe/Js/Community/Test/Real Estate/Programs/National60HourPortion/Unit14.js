...
var hr60Unit14Questions = new Array(
...
RandomQuestion = Math.floor((Math.random() * Hr60Unit14Questions.length));
CurrentExam = Hr60Unit14Questions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr60Unit14Questions.length));
RandomWA2 = Math.floor((Math.random() * Hr60Unit14Questions.length));
RandomWA3 = Math.floor((Math.random() * Hr60Unit14Questions.length));
WrongAnswer1 = Hr60Unit14Questions[RandomWA1];
WrongAnswer2 = Hr60Unit14Questions[RandomWA2];
WrongAnswer3 = Hr60Unit14Questions[RandomWA3];
