...
var hr60Unit16Questions = new Array(
...
RandomQuestion = Math.floor((Math.random() * Hr60Unit16Questions.length));
CurrentExam = Hr60Unit16Questions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr60Unit16Questions.length));
RandomWA2 = Math.floor((Math.random() * Hr60Unit16Questions.length));
RandomWA3 = Math.floor((Math.random() * Hr60Unit16Questions.length));
WrongAnswer1 = Hr60Unit16Questions[RandomWA1];
WrongAnswer2 = Hr60Unit16Questions[RandomWA2];
WrongAnswer3 = Hr60Unit16Questions[RandomWA3];
