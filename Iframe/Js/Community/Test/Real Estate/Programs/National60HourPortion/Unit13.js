...
var hr60Unit13Questions = new Array(
...
RandomQuestion = Math.floor((Math.random() * Hr60Unit13Questions.length));
CurrentExam = Hr60Unit13Questions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr60Unit13Questions.length));
RandomWA2 = Math.floor((Math.random() * Hr60Unit13Questions.length));
RandomWA3 = Math.floor((Math.random() * Hr60Unit13Questions.length));
WrongAnswer1 = Hr60Unit13Questions[RandomWA1];
WrongAnswer2 = Hr60Unit13Questions[RandomWA2];
WrongAnswer3 = Hr60Unit13Questions[RandomWA3];
