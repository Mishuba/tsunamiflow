...
var hr60Unit27Questions = new Array(
...
RandomQuestion = Math.floor((Math.random() * Hr60Unit27Questions.length));
CurrentExam = Hr60Unit27Questions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr60Unit27Questions.length));
RandomWA2 = Math.floor((Math.random() * Hr60Unit27Questions.length));
RandomWA3 = Math.floor((Math.random() * Hr60Unit27Questions.length));
WrongAnswer1 = Hr60Unit27Questions[RandomWA1];
WrongAnswer2 = Hr60Unit27Questions[RandomWA2];
WrongAnswer3 = Hr60Unit27Questions[RandomWA3];
