...
var hr60Unit11Questions = new Array(
...
RandomQuestion = Math.floor((Math.random() * Hr60Unit11Questions.length));
CurrentExam = Hr60Unit11Questions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr60Unit11Questions.length));
RandomWA2 = Math.floor((Math.random() * Hr60Unit11Questions.length));
RandomWA3 = Math.floor((Math.random() * Hr60Unit11Questions.length));
WrongAnswer1 = Hr60Unit11Questions[RandomWA1];
WrongAnswer2 = Hr60Unit11Questions[RandomWA2];
WrongAnswer3 = Hr60Unit11Questions[RandomWA3];
