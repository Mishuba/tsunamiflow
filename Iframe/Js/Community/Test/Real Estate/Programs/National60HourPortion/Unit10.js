...
var hr60Unit10Questions = new Array(
...
RandomQuestion = Math.floor((Math.random() * Hr60Unit10Questions.length));
CurrentExam = Hr60Unit10Questions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr60Unit10Questions.length));
RandomWA2 = Math.floor((Math.random() * Hr60Unit10Questions.length));
RandomWA3 = Math.floor((Math.random() * Hr60Unit10Questions.length));
WrongAnswer1 = Hr60Unit10Questions[RandomWA1];
WrongAnswer2 = Hr60Unit10Questions[RandomWA2];
WrongAnswer3 = Hr60Unit10Questions[RandomWA3];
