...
var hr60Unit20Questions = new Array(
...
RandomQuestion = Math.floor((Math.random() * Hr60Unit20Questions.length));
CurrentExam = Hr60Unit20Questions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr60Unit20Questions.length));
RandomWA2 = Math.floor((Math.random() * Hr60Unit20Questions.length));
RandomWA3 = Math.floor((Math.random() * Hr60Unit20Questions.length));
WrongAnswer1 = Hr60Unit20Questions[RandomWA1];
WrongAnswer2 = Hr60Unit20Questions[RandomWA2];
WrongAnswer3 = Hr60Unit20Questions[RandomWA3];
