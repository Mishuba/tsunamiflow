...
var hr60Unit28Questions = new Array(
...
RandomQuestion = Math.floor((Math.random() * Hr60Unit28Questions.length));
CurrentExam = Hr60Unit28Questions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr60Unit28Questions.length));
RandomWA2 = Math.floor((Math.random() * Hr60Unit28Questions.length));
RandomWA3 = Math.floor((Math.random() * Hr60Unit28Questions.length));
WrongAnswer1 = Hr60Unit28Questions[RandomWA1];
WrongAnswer2 = Hr60Unit28Questions[RandomWA2];
WrongAnswer3 = Hr60Unit28Questions[RandomWA3];
