...
var hr60Unit12Questions = new Array(
...
RandomQuestion = Math.floor((Math.random() * Hr60Unit12Questions.length));
CurrentExam = Hr60Unit12Questions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr60Unit12Questions.length));
RandomWA2 = Math.floor((Math.random() * Hr60Unit12Questions.length));
RandomWA3 = Math.floor((Math.random() * Hr60Unit12Questions.length));
WrongAnswer1 = Hr60Unit12Questions[RandomWA1];
WrongAnswer2 = Hr60Unit12Questions[RandomWA2];
WrongAnswer3 = Hr60Unit12Questions[RandomWA3];
