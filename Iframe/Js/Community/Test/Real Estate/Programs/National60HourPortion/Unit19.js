...
var hr60Unit19Questions = new Array(
...
RandomQuestion = Math.floor((Math.random() * Hr60Unit19Questions.length));
CurrentExam = Hr60Unit19Questions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr60Unit19Questions.length));
RandomWA2 = Math.floor((Math.random() * Hr60Unit19Questions.length));
RandomWA3 = Math.floor((Math.random() * Hr60Unit19Questions.length));
WrongAnswer1 = Hr60Unit19Questions[RandomWA1];
WrongAnswer2 = Hr60Unit19Questions[RandomWA2];
WrongAnswer3 = Hr60Unit19Questions[RandomWA3];
