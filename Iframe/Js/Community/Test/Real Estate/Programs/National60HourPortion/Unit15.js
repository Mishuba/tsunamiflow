...
var hr60Unit15Questions = new Array(
...
RandomQuestion = Math.floor((Math.random() * Hr60Unit15Questions.length));
CurrentExam = Hr60Unit15Questions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr60Unit15Questions.length));
RandomWA2 = Math.floor((Math.random() * Hr60Unit15Questions.length));
RandomWA3 = Math.floor((Math.random() * Hr60Unit15Questions.length));
WrongAnswer1 = Hr60Unit15Questions[RandomWA1];
WrongAnswer2 = Hr60Unit15Questions[RandomWA2];
WrongAnswer3 = Hr60Unit15Questions[RandomWA3];
