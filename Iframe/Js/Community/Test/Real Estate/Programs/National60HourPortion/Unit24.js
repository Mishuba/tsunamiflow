...
var hr60Unit24Questions = new Array(
...
RandomQuestion = Math.floor((Math.random() * Hr60Unit24Questions.length));
CurrentExam = Hr60Unit24Questions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr60Unit24Questions.length));
RandomWA2 = Math.floor((Math.random() * Hr60Unit24Questions.length));
RandomWA3 = Math.floor((Math.random() * Hr60Unit24Questions.length));
WrongAnswer1 = Hr60Unit24Questions[RandomWA1];
WrongAnswer2 = Hr60Unit24Questions[RandomWA2];
WrongAnswer3 = Hr60Unit24Questions[RandomWA3];
