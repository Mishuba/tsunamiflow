...
var hr60Unit9Questions = new Array(
...
RandomQuestion = Math.floor((Math.random() * Hr60Unit9Questions.length));
CurrentExam = Hr60Unit9Questions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr60Unit9Questions.length));
RandomWA2 = Math.floor((Math.random() * Hr60Unit9Questions.length));
RandomWA3 = Math.floor((Math.random() * Hr60Unit9Questions.length));
WrongAnswer1 = Hr60Unit9Questions[RandomWA1];
WrongAnswer2 = Hr60Unit9Questions[RandomWA2];
WrongAnswer3 = Hr60Unit9Questions[RandomWA3];
