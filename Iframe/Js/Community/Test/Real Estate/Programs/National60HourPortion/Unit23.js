...
var hr60Unit23Questions = new Array(
...
RandomQuestion = Math.floor((Math.random() * Hr60Unit23Questions.length));
CurrentExam = Hr60Unit23Questions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr60Unit23Questions.length));
RandomWA2 = Math.floor((Math.random() * Hr60Unit23Questions.length));
RandomWA3 = Math.floor((Math.random() * Hr60Unit23Questions.length));
WrongAnswer1 = Hr60Unit23Questions[RandomWA1];
WrongAnswer2 = Hr60Unit23Questions[RandomWA2];
WrongAnswer3 = Hr60Unit23Questions[RandomWA3];
