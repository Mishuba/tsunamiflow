...
var hr60Unit25Questions = new Array(
...
RandomQuestion = Math.floor((Math.random() * Hr60Unit25Questions.length));
CurrentExam = Hr60Unit25Questions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr60Unit25Questions.length));
RandomWA2 = Math.floor((Math.random() * Hr60Unit25Questions.length));
RandomWA3 = Math.floor((Math.random() * Hr60Unit25Questions.length));
WrongAnswer1 = Hr60Unit25Questions[RandomWA1];
WrongAnswer2 = Hr60Unit25Questions[RandomWA2];
WrongAnswer3 = Hr60Unit25Questions[RandomWA3];
