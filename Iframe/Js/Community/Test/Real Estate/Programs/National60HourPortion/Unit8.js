...
var hr60Unit8Questions = new Array(
...
RandomQuestion = Math.floor((Math.random() * Hr60Unit8Questions.length));
CurrentExam = Hr60Unit8Questions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr60Unit8Questions.length));
RandomWA2 = Math.floor((Math.random() * Hr60Unit8Questions.length));
RandomWA3 = Math.floor((Math.random() * Hr60Unit8Questions.length));
WrongAnswer1 = Hr60Unit8Questions[RandomWA1];
WrongAnswer2 = Hr60Unit8Questions[RandomWA2];
WrongAnswer3 = Hr60Unit8Questions[RandomWA3];
