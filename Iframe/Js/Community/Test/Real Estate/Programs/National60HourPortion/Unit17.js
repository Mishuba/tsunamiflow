...
var hr60Unit17Questions = new Array(
...
RandomQuestion = Math.floor((Math.random() * Hr60Unit17Questions.length));
CurrentExam = Hr60Unit17Questions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr60Unit17Questions.length));
RandomWA2 = Math.floor((Math.random() * Hr60Unit17Questions.length));
RandomWA3 = Math.floor((Math.random() * Hr60Unit17Questions.length));
WrongAnswer1 = Hr60Unit17Questions[RandomWA1];
WrongAnswer2 = Hr60Unit17Questions[RandomWA2];
WrongAnswer3 = Hr60Unit17Questions[RandomWA3];
