...
var hr30UnitCurrentEthnicsIssuesQuestions = new Array(
...
function UnitExamCurrentEthnicsIssues() {
RandomAnswer = Math.floor((Math.random() * AnswerKey.length));
RandomQuestion = Math.floor((Math.random() * Hr30UnitCurrentEthnicsIssuesQuestions.length));
CurrentExam = Hr30UnitCurrentEthnicsIssuesQuestions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr30UnitCurrentEthnicsIssuesQuestions.length));
RandomWA2 = Math.floor((Math.random() * Hr30UnitCurrentEthnicsIssuesQuestions.length));
RandomWA3 = Math.floor((Math.random() * Hr30UnitCurrentEthnicsIssuesQuestions.length));
WrongAnswer1 = Hr30UnitCurrentEthnicsIssuesQuestions[RandomWA1];
WrongAnswer2 = Hr30UnitCurrentEthnicsIssuesQuestions[RandomWA2];
WrongAnswer3 = Hr30UnitCurrentEthnicsIssuesQuestions[RandomWA3];
