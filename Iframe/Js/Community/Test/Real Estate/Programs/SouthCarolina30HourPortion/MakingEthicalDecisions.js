...
var hr30UnitMakingEthicalDecisionsQuestions = new Array(
...
function UnitExamMakingEthicalDecisions() {
RandomAnswer = Math.floor((Math.random() * AnswerKey.length));
RandomQuestion = Math.floor((Math.random() * Hr30UnitMakingEthicalDecisionsQuestions.length));
CurrentExam = Hr30UnitMakingEthicalDecisionsQuestions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr30UnitMakingEthicalDecisionsQuestions.length));
RandomWA2 = Math.floor((Math.random() * Hr30UnitMakingEthicalDecisionsQuestions.length));
RandomWA3 = Math.floor((Math.random() * Hr30UnitMakingEthicalDecisionsQuestions.length));
WrongAnswer1 = Hr30UnitMakingEthicalDecisionsQuestions[RandomWA1];
WrongAnswer2 = Hr30UnitMakingEthicalDecisionsQuestions[RandomWA2];
WrongAnswer3 = Hr30UnitMakingEthicalDecisionsQuestions[RandomWA3];
