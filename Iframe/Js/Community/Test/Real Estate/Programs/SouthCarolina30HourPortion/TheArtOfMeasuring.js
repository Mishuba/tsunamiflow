...
var hr30UnitTheArtOfMeasuringQuestions = new Array(
...
function UnitExamTheArtOfMeasuring() {
RandomAnswer = Math.floor((Math.random() * AnswerKey.length));
RandomQuestion = Math.floor((Math.random() * Hr30UnitTheArtOfMeasuringQuestions.length));
CurrentExam = Hr30UnitTheArtOfMeasuringQuestions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr30UnitTheArtOfMeasuringQuestions.length));
RandomWA2 = Math.floor((Math.random() * Hr30UnitTheArtOfMeasuringQuestions.length));
RandomWA3 = Math.floor((Math.random() * Hr30UnitTheArtOfMeasuringQuestions.length));
WrongAnswer1 = Hr30UnitTheArtOfMeasuringQuestions[RandomWA1];
WrongAnswer2 = Hr30UnitTheArtOfMeasuringQuestions[RandomWA2];
WrongAnswer3 = Hr30UnitTheArtOfMeasuringQuestions[RandomWA3];
