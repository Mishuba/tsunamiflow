...
var hr30UnitRealEstateContractsQuestions = new Array(
...
function UnitExamRealEstateContracts() {
RandomAnswer = Math.floor((Math.random() * AnswerKey.length));
RandomQuestion = Math.floor((Math.random() * Hr30UnitRealEstateContractsQuestions.length));
CurrentExam = Hr30UnitRealEstateContractsQuestions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr30UnitRealEstateContractsQuestions.length));
RandomWA2 = Math.floor((Math.random() * Hr30UnitRealEstateContractsQuestions.length));
RandomWA3 = Math.floor((Math.random() * Hr30UnitRealEstateContractsQuestions.length));
WrongAnswer1 = Hr30UnitRealEstateContractsQuestions[RandomWA1];
WrongAnswer2 = Hr30UnitRealEstateContractsQuestions[RandomWA2];
WrongAnswer3 = Hr30UnitRealEstateContractsQuestions[RandomWA3];
