...
var hr30UnitHistoryLanguageAndGuidelinesQuestions = new Array(
...
function UnitExamHistoryLanguageAndGuidelines() {
RandomAnswer = Math.floor((Math.random() * AnswerKey.length));
RandomQuestion = Math.floor((Math.random() * Hr30UnitHistoryLanguageAndGuidelinesQuestions.length));
CurrentExam = Hr30UnitHistoryLanguageAndGuidelinesQuestions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr30UnitHistoryLanguageAndGuidelinesQuestions.length));
RandomWA2 = Math.floor((Math.random() * Hr30UnitHistoryLanguageAndGuidelinesQuestions.length));
RandomWA3 = Math.floor((Math.random() * Hr30UnitHistoryLanguageAndGuidelinesQuestions.length));
WrongAnswer1 = Hr30UnitHistoryLanguageAndGuidelinesQuestions[RandomWA1];
WrongAnswer2 = Hr30UnitHistoryLanguageAndGuidelinesQuestions[RandomWA2];
WrongAnswer3 = Hr30UnitHistoryLanguageAndGuidelinesQuestions[RandomWA3];
