...
var hr30UnitEnforcementOfTheNARCodeOfEthnicsQuestions = new Array(
...
function UnitExamEnforementOfTheNARCodeEthnics() {
RandomAnswer = Math.floor((Math.random() * AnswerKey.length));
RandomQuestion = Math.floor((Math.random() * Hr30UnitEnforcementOfTheNARCodeOfEthnicsQuestions.length));
CurrentExam = Hr30UnitEnforcementOfTheNARCodeOfEthnicsQuestions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr30UnitEnforcementOfTheNARCodeOfEthnicsQuestions.length));
RandomWA2 = Math.floor((Math.random() * Hr30UnitEnforcementOfTheNARCodeOfEthnicsQuestions.length));
RandomWA3 = Math.floor((Math.random() * Hr30UnitEnforcementOfTheNARCodeOfEthnicsQuestions.length));
WrongAnswer1 = Hr30UnitEnforcementOfTheNARCodeOfEthnicsQuestions[RandomWA1];
WrongAnswer2 = Hr30UnitEnforcementOfTheNARCodeOfEthnicsQuestions[RandomWA2];
WrongAnswer3 = Hr30UnitEnforcementOfTheNARCodeOfEthnicsQuestions[RandomWA3];
