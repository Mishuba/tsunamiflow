...
var hr30UnitIncomeTaxCharacteristicsOfTheRealEstateINvestmentQuestions = new Array(
...
function UnitExamIncomeTaxCharacteristicsOfTheRealEstateInvestment() {
RandomAnswer = Math.floor((Math.random() * AnswerKey.length));
RandomQuestion = Math.floor((Math.random() * Hr30UnitIncomeTaxCharacteristicsOfTheRealEstateInvestmentQuestions.length));
CurrentExam = Hr30UnitIncomeTaxCharacteristicsOfTheRealEstateInvestmentQuestions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr30UnitIncomeTaxCharacteristicsOfTheRealEstateInvestmentQuestions.length));
RandomWA2 = Math.floor((Math.random() * Hr30UnitIncomeTaxCharacteristicsOfTheRealEstateInvestmentQuestions.length));
RandomWA3 = Math.floor((Math.random() * Hr30UnitIncomeTaxCharacteristicsOfTheRealEstateInvestmentQuestions.length));
WrongAnswer1 = Hr30UnitIncomeTaxCharacteristicsOfTheRealEstateInvestmentQuestions[RandomWA1];
WrongAnswer2 = Hr30UnitIncomeTaxCharacteristicsOfTheRealEstateInvestmentQuestions[RandomWA2];
WrongAnswer3 = Hr30UnitIncomeTaxCharacteristicsOfTheRealEstateInvestmentQuestions[RandomWA3];
