...
var hr30UnitStylesDesignsAndWhatCountsQuestions = new Array(
...
function UnitExamStylesDesignsAndWhatCounts() {
RandomAnswer = Math.floor((Math.random() * AnswerKey.length));
RandomQuestion = Math.floor((Math.random() * Hr30UnitStylesDesignsAndWhatCountsQuestions.length));
CurrentExam = Hr30UnitStylesDesignsAndWhatCountsQuestions[RandomQuestion];
ChooseSpot = AnswerKey[RandomAnswer];
RandomWA1 = Math.floor((Math.random() * Hr30UnitStylesDesignsAndWhatCountsQuestions.length));
RandomWA2 = Math.floor((Math.random() * Hr30UnitStylesDesignsAndWhatCountsQuestions.length));
RandomWA3 = Math.floor((Math.random() * Hr30UnitStylesDesignsAndWhatCountsQuestions.length));
WrongAnswer1 = Hr30UnitStylesDesignsAndWhatCountsQuestions[RandomWA1];
WrongAnswer2 = Hr30UnitStylesDesignsAndWhatCountsQuestions[RandomWA2];
WrongAnswer3 = Hr30UnitStylesDesignsAndWhatCountsQuestions[RandomWA3];
