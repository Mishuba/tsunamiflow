export class letsDoIt {
    constructor(TfGameName, player) {
        ...
        this.XRank = Math.pow(10, 100);
        this.Godly = Math.pow(10, 97);
        this.MRank = Math.pow(10, 96);
        this.DemiGodRank = Math.pow(10, 93);
        this.YRank = Math.pow(10, 92)
        this.GodLike = Math.pow(10, 91);
        this.TsunamiFlowRank = Math.pow(10, 89);
        this.ZRank = Math.pow(10, 88);
        this.TranscendentLevel = Math.pow(10, 86);
        this.SSSRank = Math.pow(10, 85);
        this.GigaRank = Math.pow(10, 83);
        this.SSRank = Math.pow(10, 82);
        this.HyperRank = Math.pow(10, 80);
        this.SRank = Math.pow(10, 79);
        this.UltraRank = Math.pow(10, 77);
        this.ARank = Math.pow(10, 76);
        this.UniverseRank = Math.pow(10, 74);
        this.BRank = Math.pow(10, 73);
        this.RankBlackHoleLevel = Math.pow(10, 71);
        this.CRank = Math.pow(10, 70);
        this.RankStarLevel = Math.pow(10, 68);
        this.DRank = Math.pow(10, 67);
        this.RankSuperGalaxyLevel = Math.pow(10, 63);
        this.ERank = Math.pow(10, 64);
        this.RankGalaxyLevel = Math.pow(10, 62);
        this.FRank = Math.pow(10, 61);
        this.RankSolarSystemLevel = Math.pow(10, 59);
        this.GRank = Math.pow(10, 58);
        this.RankPlanetLevel = Math.pow(10, 56);
        this.HRank = Math.pow(10, 55);
        this.RankMoonLevel = Math.pow(10, 53);
        this.IRank = Math.pow(10, 52);
        this.RankOceanLevel = Math.pow(10, 49);
        this.JRank = Math.pow(10, 48);
        this.CommandarRank = Math.pow(10, 47);
        this.HuhCOmmander = Math.pow(10, 46);
        this.WoahWcommandar = Math.pow(10, 45);
        this.KRank = Math.pow(10, 44);
        this.Continent2Rank = Math.pow(10, 43);
        this.Continent1Rank = Math.pow(10, 42);
        this.RankContinentLevel = Math.pow(10, 41);
        this.LRank = Math.pow(10, 40);
        this.Country1Rank = Math.pow(10, 39);
        this.Country2Rank = Math.pow(10, 38);
        this.CountryLevel = Math.pow(10, 37);
        this.NRank = Math.pow(10, 36);
